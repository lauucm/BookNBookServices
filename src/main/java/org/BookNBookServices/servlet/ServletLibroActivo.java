...
@WebServlet("/activosServlet")
@AllArgsConstructor
public class ServletLibroActivo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            ArrayList<Libro> listado = servicio.listarLibrosenLectura(idUsuario).getListado();
