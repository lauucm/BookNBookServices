...
@WebServlet("/noLeidosServlet")
@AllArgsConstructor
public class ServletLibroNoLeido extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            ArrayList<Libro> listado = servicio.listarLibrosNoLeidos(idUsuario).getListado();
